/*
 *  Write a program that prints the area and circumference of a circle, given its radius.
 */
...
public class CircleComputation {    // Save as "CircleComputation.java"
    public static void main(String[] args) {
        ...
        // Declare as "final" to specify that its value cannot be changed (i.e. cosntant).
        final double PI = 3.14159265;

        // Assign a value to radius. (We shall read in the value from the keyboard larter).
        radius = 1.2;
        ...
        // Prints results
        System.out.print("The radius is "); // Print descripton
